    ...
    <div>
      ...
      <nav className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 mb-10">
        ...
        <ol className="list-decimal list-inside text-sm space-y-1 text-neutral-500 dark:text-neutral-400">
          <li><a href="#vocabulary" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Vocabulary</a></li>
          <li><a href="#signals" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Signals</a></li>
          <li><a href="#affinities" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Affinities</a></li>
          <li><a href="#scoring" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Scoring</a></li>
          <li><a href="#clustering" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Clustering</a></li>
          <li><a href="#consent-layers" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Consent layers</a></li>
          <li><a href="#campaigns" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Campaigns</a></li>
          <li><a href="#feed" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Feed</a></li>
          <li><a href="#analytics" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Analytics</a></li>
          <li><a href="#composition" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Composition patterns</a></li>
        </ol>
      </nav>
      ...
      <section id="vocabulary" className="mb-12">
        ...
        <div className="mb-4 rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 px-4 py-3 text-sm text-neutral-500 dark:text-neutral-400">
          <p className="font-medium text-neutral-900 dark:text-neutral-100 mb-1">Examples by domain</p>
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/config/signal_types</code>{" "}
      ...
      <section id="signals" className="mb-12">
        ...
        <table className="w-full text-sm mb-4">
          <thead>
            <tr className="border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950">
              <th className="text-left px-4 py-2.5 font-medium text-neutral-500 dark:text-neutral-400">Field</th>
              <th className="text-left px-4 py-2.5 font-medium text-neutral-500 dark:text-neutral-400">Description</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border">
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">signal_type_id</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">The kind of behavior (e.g. &quot;like&quot;, &quot;purchase&quot;, &quot;view&quot;)</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">target_id</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">What the user interacted with</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">target_type</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">The kind of target (&quot;user&quot;, &quot;content&quot;, &quot;tag&quot;, etc.)</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">strength</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Numeric weight (0.0&ndash;1.0). Defaults based on signal type config.</td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="mb-4 rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 px-4 py-3 text-sm text-neutral-500 dark:text-neutral-400">
          <p className="font-medium text-neutral-900 dark:text-neutral-100 mb-1">The same primitive, different meanings</p>
          <ul className="list-disc list-inside space-y-0.5">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/signal_batches</code>{" "}
      ...
      <section id="affinities" className="mb-12">
        ...
        <p className="mb-4 text-neutral-500 dark:text-neutral-400">
          The{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/users/{"{external_id}"}/affinity/summary</code>{" "}
      ...
      <section id="scoring" className="mb-12">
        ...
        <div className="mb-4 rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 px-4 py-3 text-sm text-neutral-500 dark:text-neutral-400">
          <p className="font-medium text-neutral-900 dark:text-neutral-100 mb-1">Preset examples</p>
          <ul className="list-disc list-inside space-y-0.5">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          Use{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/config/scoring/schema</code>{" "}
          to see all available scoring dimensions and their valid ranges, then{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/config/scoring</code>{" "}
      ...
      <section id="clustering" className="mb-12">
        ...
        <p className="mb-3 text-neutral-500 dark:text-neutral-400">Clusters are useful for:</p>
        <ul className="list-disc pl-5 space-y-1 mb-4 text-neutral-500 dark:text-neutral-400">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          Each user has a{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">cluster_id</code> and{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">cluster_confidence</code>{" "}
          on their profile. List clusters via{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/clusters</code>{" "}
          and view members via{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/clusters/{"{id}"}/members</code>.
        </p>
      </section>
      ...
      <section id="consent-layers" className="mb-12">
        ...
        <div className="mb-4 rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 px-4 py-3 text-sm text-neutral-500 dark:text-neutral-400">
          <p className="font-medium text-neutral-900 dark:text-neutral-100 mb-1">When you need consent layers</p>
          <ul className="list-disc list-inside space-y-0.5">
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/config/consent_layers</code>{" "}
          and user consent is managed via{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/clients/{"{client_id}"}/users/{"{user_id}"}/consents</code>.
        </p>
      </section>
      ...
      <section id="campaigns" className="mb-12">
        ...
        <ol className="list-decimal pl-5 space-y-1 mb-4 text-neutral-500 dark:text-neutral-400">
      ...
      <section id="feed" className="mb-12">
        ...
        <p className="mb-4 text-neutral-500 dark:text-neutral-400">
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/users/{"{external_id}"}/feed/ranked</code>{" "}
        ...
        <p className="text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">GET /api/v1/users/{"{external_id}"}/matches</code>{" "}
      ...
      <section id="analytics" className="mb-12">
        ...
        <table className="w-full text-sm mb-4">
          <thead>
            <tr className="border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950">
              <th className="text-left px-4 py-2.5 font-medium text-neutral-500 dark:text-neutral-400">Endpoint</th>
              <th className="text-left px-4 py-2.5 font-medium text-neutral-500 dark:text-neutral-400">What it shows</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border">
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/overview</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Totals and last-24h activity (users, signals, matches, impressions)</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/signals</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Signal volume by type, time period, and trend</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/affinities</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Affinity distribution and coverage across your user base</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/clustering</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Cluster sizes, distribution, and assignment coverage</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/campaigns</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Campaign performance: impressions, spend, engagement rates</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/vocabulary</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">Tag and topic usage across signals and affinities</td>
            </tr>
            <tr>
              <td className="px-4 py-2.5"><code className="text-xs">/analytics/growth</code></td>
              <td className="px-4 py-2.5 text-neutral-500 dark:text-neutral-400">User and signal growth over time</td>
            </tr>
          </tbody>
        </table>
        <p className="text-neutral-500 dark:text-neutral-400">
      ...
      <section id="composition" className="mb-12">
        ...
        <div className="text-sm mt-6 p-3 rounded-md border border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30 text-neutral-500 dark:text-neutral-400">
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-neutral-500 dark:text-neutral-400">
          ...
          <li>
            <Link href="/docs/authentication" className="text-amber-600 dark:text-amber-400 hover:underline">
              Authentication
            </Link>{" "}
