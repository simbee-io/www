    ...
    <div>
      ...
      <nav className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4 mb-10">
        ...
        <ol className="list-decimal list-inside text-sm space-y-1 text-neutral-500 dark:text-neutral-400">
          <li><a href="#setup" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Setup</a></li>
          <li><a href="#signal-types" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Define signal types</a></li>
          <li><a href="#users" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Create users</a></li>
          <li><a href="#signals" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Record signals</a></li>
          <li><a href="#affinities" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Observe affinities</a></li>
          <li><a href="#feed" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Query the ranked feed</a></li>
          <li><a href="#clusters" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">View clusters</a></li>
          <li><a href="#campaigns" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Create a campaign</a></li>
          <li><a href="#webhooks" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Subscribe to webhooks</a></li>
          <li><a href="#analytics" className="hover:text-neutral-900 dark:text-neutral-100 transition-colors">Check analytics</a></li>
        </ol>
      </nav>

      <div className="text-sm mb-10 p-3 rounded-md border border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950/30 text-neutral-500 dark:text-neutral-400">
        ...
        <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">token</code> variable.
      </div>
...
export SIMBEE_URL="https://api.simbee.io"`,
        ...
        <p className="mt-4 mb-4 text-neutral-500 dark:text-neutral-400">
  ...
  "data": {
    ...
    "updated_at": "2026-04-11T12:00:00Z"
        ...
        <p className="text-sm mt-2 text-neutral-500 dark:text-neutral-400">
          The <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">key</code> is
          what you&apos;ll use when recording signals. The <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">id</code> is
      ...
      <section id="users" className="mb-12">
        ...
        <p className="mb-4 text-neutral-500 dark:text-neutral-400">
          Create users with an <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">external_id</code> that
          maps to your system&apos;s user identifier. You can attach arbitrary{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">traits</code> as a JSON object.
        </p>
          ...
          <code>{`// 201 Created
{
  "data": {
    ...
    "updated_at": "2026-04-11T12:00:00Z"
        ...
        <p className="text-sm mt-2 text-neutral-500 dark:text-neutral-400">
          Use <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">external_id</code> in
          all subsequent calls. For bulk creation, use{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">POST /api/v1/users/batch</code> with
          ...
          <code>{`// 201 Created
{
  "data": {
    ...
    "created_at": "2026-04-11T12:01:00Z"
        ...
        <p className="text-sm mt-2 text-neutral-500 dark:text-neutral-400">
          Notice the <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">strength</code> is
...
print(summary.data)`,
        ...
        <p className="text-sm mt-4 text-neutral-500 dark:text-neutral-400">
...
for item in results.data:
    print(item)`,
        ...
        <p className="text-sm mt-4 text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">cursor</code> parameter
          from the response to fetch the next page. See{" "}
          <Link href="/docs/concepts#scoring" className="text-amber-600 dark:text-amber-400 hover:underline">
            Scoring
          </Link>{" "}
...
members = clustering_api.list_api_v1_cluster_members(clusters.data[0].id)`,
        ...
        <p className="text-sm mt-4 text-neutral-500 dark:text-neutral-400">
          ...
          <Link href="/docs/concepts#clustering" className="text-amber-600 dark:text-amber-400 hover:underline">
            Clustering
          </Link>{" "}
...
campaigns_api.activate_api_v1_campaign(campaign.data.id)`,
        ...
        <p className="text-sm mt-4 text-neutral-500 dark:text-neutral-400">
          ...
          <Link href="/docs/concepts#campaigns" className="text-amber-600 dark:text-amber-400 hover:underline">
            Campaigns
          </Link>{" "}
  ...
  "data": {
    ...
    "created_at": "2026-04-11T12:05:00Z"
        ...
        <p className="text-sm mt-2 text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">X-Simbee-Signature</code>{" "}
  ...
  "data": {
    ...
    "computed_at": "2026-04-11T12:10:00Z"
        ...
        <p className="text-sm mt-2 text-neutral-500 dark:text-neutral-400">
          ...
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">/analytics/signals</code>,{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">/analytics/affinities</code>,{" "}
          <code className="text-xs bg-neutral-50 dark:bg-neutral-950 px-1.5 py-0.5 rounded">/analytics/clustering</code>,
          and more. See the{" "}
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-neutral-500 dark:text-neutral-400">
          ...
          <li>
            <Link href="/docs/concepts#consent-layers" className="text-amber-600 dark:text-amber-400 hover:underline">
              Consent layers
            </Link>{" "}
